  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-display font-extrabold tracking-tight mb-2">Institutional Intelligence</h1>
          <p className="text-white/40 font-medium">Real-time global market data and institutional-grade insights.</p>
        </div>
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={cn(
                        ...
                        item.impact === 'High' ? "bg-red-500/10 text-red-500" : "bg-neon-green/10 text-neon-green"
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-white/60">Institutional Sentiment</span>
                  <span className="text-xs font-mono font-bold text-neon-green">82 (Strong Greed)</span>
                </div>
              </div>
            </div>
          </div>
