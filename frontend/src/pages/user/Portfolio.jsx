          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bento-card">
              ...
              <div className="flex items-end justify-between mb-4">
                <h3 className="text-3xl font-display font-bold">Moderate</h3>
                <span className="text-xs font-bold text-yellow-400">Beta: 1.12</span>
              </div>
              <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-neon-green via-yellow-400 to-red-500 w-[60%]"></div>
              </div>
            </div>
            <div className="bento-card">
                    ...
                    <tr key={i} className="group cursor-pointer">
                      ...
                      <td className="px-4 py-3 bg-white/5 border-y border-white/5 group-hover:border-neon-green/30 transition-all">
                        <div className="flex items-center gap-1">
                          ...
                          <span className={cn(
                            "text-[10px] font-bold",
                            item.pnlPct.startsWith('+') ? "text-neon-green/60" : item.pnlPct === '0.0%' ? "text-white/20" : "text-red-500/60"
                          )}>({item.pnlPct})</span>
                        </div>
                      </td>
